...
plot(data_raw$MovementTime, m.res, ylab="Residuals", xlab="MovementTime", main="Titel")
```
...
plot(data_raw$ErrorRate, m.res, ylab="Residuals", xlab="ErrorRate", main="Titel")
```
...
plot(data_raw$Throughput, m.res, ylab="Residuals", xlab="Throughput", main="Titel")
```
